    ...
    (let ((els (%py-list-elems obj)))
      (let ((n (List length els)))
        (match
          ...
          ((Str8 =? name "copy") (fn (_) (%py-list-new (%py-list-elems obj))))
          ((Str8 =? name "count")
        ...
        (if (if (str? v) #t (if (= tc 115) #t (if (%py-obj-is v) #t (if (null? v) #t (if (%py-list? v) #t (%py-tuple-is v))))))
          ...
          (do
            ...
            (if (if (eq? kind (lit int))
              ...
              (do
                ...
                (def m
                  (match
                    ((if (= tc 120) #t (= tc 88))
                      (%py-fmt-base w 16
                        (if (= tc 88) "0123456789ABCDEF" "0123456789abcdef")))
              ...
              (if (match
                    ((= tc 0) #t)   ((= tc 101) #t) ((= tc 69) #t)
                    ((= tc 102) #t) ((= tc 70) #t)  ((= tc 103) #t)
                    ((= tc 71) #t)  ((= tc 110) #t) ((= tc 37) #t)
                    (#t #f))
                (do
                  ...
                  (if (not (eq? ekind (lit num)))
                    ...
                    (do
                      ...
                      (def body
                        (match
                        ((if (= tc 101) #t (= tc 69)) (%py-fmt-e D x10 p upper))
...
(def %py-fmtfield
  (fn (_ v conv spec)
    (let ((cv (match
                ...
                ((Str8 =? conv "")  v)
                (#t (Err raise (lit value) "Unknown conversion specifier" ())))))
