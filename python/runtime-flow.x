...
; door is its export libm-fn, taken by a selective import inside a call: this
; file has no module of its own, so an import at its top would bind libm-fn in
; the root, where x/num/float keeps its plain exports out.
